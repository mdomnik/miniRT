...
/*   Updated: 2025/01/16 19:31:18 by mdomnik          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_shape *ice_cream_cone(void)
{
	...
	scoop->material.color = new_color3(0.4, 0.8, 0.4);
	...
	scoop2->material.color = new_color3(1, 0.2, 0.9);
	...
	scoop3->material.color = new_color3(0.2, 0.6, 0.9);
