...
/*   Updated: 2024/11/19 20:13:17 by mdomnik          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_world *test_world(void)
{
	...
	add_shape(&world->shapes, floor);
	add_shape(&world->shapes, left_wall);
	add_shape(&world->shapes, right_wall);
	add_shape(&world->shapes, middle);
	add_shape(&world->shapes, right);
	add_shape(&world->shapes, left);
	add_light(&world->light, l1);
	return (world);
}
