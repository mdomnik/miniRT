...
t_material *default_material(void)
{
	...
	material = gc_malloc(sizeof(*material));
...
// 	world->shapes = NULL;
// 	world->light = NULL;
// 	t_light_p *l1 = new_light(new_point3_p(-10, 10, -10), new_color3(1, 1, 1));
// 	// t_light_p *l2 = new_light(new_point3_p(10, -10, -10), new_color3(0.1, 0.8, 0.1));
// 	t_shape  *s1 = sphere();
...
// 	t_light_p *l1 = new_light(new_point3_p(-10, 10, -10), new_color3(1, 1, 1));
// 	t_shape  *floor = plane();
// 	floor->material.pattern = new_pattern(CHECKERS, new_color3(0.8, 0.2, 0.2), new_color3(0.2, 1, 0.2));
...
// 	wall->material.pattern = new_pattern(CHECKERS, new_color3(0.8, 0.2, 0.2), new_color3(0.2, 1, 0.2));
// 	set_pattern_transform(wall->material.pattern, multiply_matrices(rotation_y(M_PI / 2), scaling(0.5, 0.5, 0.5)));
// 	wall->material.color = new_color3(1, 0.9, 0.9);
// 	wall->material.reflective = 0;
// 	wall->material.specular = 0;
// 	t_shape  *middle = sphere();
// 	set_transform(middle, translation(-0.5, 1, 0.5));
// 	middle->material.pattern = new_pattern(RING, new_color3(0.5, 0.3, 0.9), new_color3(0.1, 0.5, 0.8));
...
// 	// right->material.pattern = new_pattern(GRADIENT, new_color3(0.8, 0.1, 0.1), new_color3(0.1, 1, 0.8));
...
// 	t_shape  *left = cube();
// 	set_transform(left, multiply_matrices(translation(-1.5, 0.33, -0.75), scaling(0.33, 0.33, 0.33)));
// 	left->material.pattern = new_pattern(CHECKERS, new_color3(0.8, 0.2, 0.2), new_color3(0.2, 1, 0.2));
// 	left->material.color = new_color3(1, 0.8, 0.1);
// 	left->material.diffuse = 0.7;
// 	left->material.specular = 0.3;
// 	t_shape *con = cone();
// 	set_transform(con, multiply_matrices(translation(0, 0.8, -0.75), scaling(0.5, 0.5, 0.5)));
// 	con->material.color = new_color3(0.5, 1, 0.1);
...
// 	t_shape *p = plane();
// 	p->material.color = new_color3(0.9, 0.9, 0.9);
...
// 
// 	// Add light
// 	t_light_p *l = new_light(new_point3_p(-10, 10, -10), new_color3(1, 1, 1));
// 	add_light(&w->light, l);
// 
// 	// Add sphere with a checker texture map
// 	t_shape *s = sphere();
...
// 
// 	// Add lights
// 	add_light(&world->light, new_light(new_point3_p(0, 100, -100), new_color3(0.25, 0.25, 0.25)));
// 	add_light(&world->light, new_light(new_point3_p(0, -100, -100), new_color3(0.25, 0.25, 0.25)));
// 	add_light(&world->light, new_light(new_point3_p(-100, 0, -100), new_color3(0.25, 0.25, 0.25)));
// 	add_light(&world->light, new_light(new_point3_p(100, 0, -100), new_color3(0.25, 0.25, 0.25)));
// 
...
// 
// 	// Add light source
// 	t_light_p *light = new_light(new_point3_p(-100, 100, -100), new_color3(1, 1, 1));
// 	world->light = light;
// 
// 	// Add plane
// 	t_shape *p = plane();
// 	p->material.color = new_color3(1, 1, 1);
...
// 	// Add cylinder
// 	t_shape *c = cylinder();
// 	c->material.color = new_color3(1, 1, 1);
...
// 
// 	// Add light source
// 	t_light_p *light = new_light(new_point3_p(0, 100, 0), new_color3(1, 1, 1));
// 	world->light = light;
// 
...
// 
// 	// Add light source
// 	t_light_p *light2 = new_light(new_point3_p(100, -100, -100), new_color3(1, 1, 1));
// 	t_light_p *light = new_light(new_point3_p(-100, 100, -100), new_color3(1, 0.5, 1));
...
// 	s->material.diffuse = 0.9;
// 	s->material.color = new_color3(0.42, 0.42, 0.42);
// 	s->material.specular = 0.1;
// 	s->material.shininess = 10;
// 	s->material.ambient = 0.1;
// 
...
// 	world->shapes = NULL;
// 	world->light = NULL;
// 	t_light_p *l1 = new_light(new_point3_p(-5, 10, -5), new_color3(1, 1, 1));
// 	t_shape  *floor = plane();
...
// 	// printf("cone min: %f\n", c->size_cap->min);
// 	// printf("cone max: %f\n", c->size_cap->max);
// 	// icecream->material.color = new_color3(1, 0.5, 0.5);
